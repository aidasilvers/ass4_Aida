...
import (
	...
	"aida.net/pkg/jsonlog"
	"aida.net/pkg/store"
	"aida.net/pkg/store/postgres"
	"aida.net/services/contact/internal/delivery"
	"aida.net/services/contact/internal/repository"
	"aida.net/services/contact/internal/useCase"
